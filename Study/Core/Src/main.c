...
//	  HAL_GPIO_WritePin(GPIO_LED_GPIO_Port, GPIO_LED_Pin, 0);
	  ...
	  else if (HAL_GPIO_ReadPin(GPIO_SW_GPIO_Port, GPIO_SW_Pin) == 1)
	  {
		  HAL_GPIO_WritePin(GPIO_LED_GPIO_Port, GPIO_LED_Pin, 0);
	  }
#endif
...
static void MX_GPIO_Init(void)
{
  ...
  /* RCC : Reset and clock control RCC */
  /* Please refer 3.3 Memory Map */
  __HAL_RCC_GPIOC_CLK_ENABLE(); // *(0x40021018)|= 16
  __HAL_RCC_GPIOA_CLK_ENABLE(); // *(0x40021018)|= 4

  /*Configure GPIO pin Output Level */
  // GPIO_LED_GPIO_Port is address 0x40011000
